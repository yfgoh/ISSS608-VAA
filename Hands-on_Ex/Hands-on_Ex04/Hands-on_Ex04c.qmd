...
Visualising uncertainty is relatively new in statistical graphics. To create statistical graphics for visualising uncertainty, the following will be covered in this hands-on exercise.
...
::: {.callout-note .Things .to .learn .from .the .code .chunk .above}
...
### 4.1 Visualising the uncertainty of point estimates: ggdist methods
...
### 4.2 Visualising the uncertainty of point estimates: ggdist methods
...
### 4.3 Visualising the uncertainty of point estimates: ggdist methods
...
## 5 Visualising Uncertainty With Hypothetical Outcomes Plots (HOPs)
...
### 5.3 Visualing Uncertainty with Hypothetical Outcome Plots (HOPs)
