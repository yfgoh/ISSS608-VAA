...
This hands-on exercise will allow one to create the followings data visualisation by using R packages:
...
::: {#Things to learn from the code chunk} - a tibble data table called *grouped* is derived by aggregating the attack by *wkday* and *hour* fields.
...
This section will be covering how to plot a [slopegraph](https://www.storytellingwithdata.com/blog/2020/7/27/what-is-a-slopegraph) by using R.
