...
This hands-on exercise will be covering how to:
...
This section covers how to plot sparklines by using ggplot2.
...
Before preparing the sales report by product by using gtExtras functions, code chunk below will be used to prepare the data.
...
In this section covers how to create interactive information dashboard by using [reactable](https://glin.github.io/reactable/index.html) and [reactablefmtr](https://kcuilla.github.io/reactablefmtr/index.html) packages. Before getting started, it is highly recommended to visit the webpage of these two packages and review all the materials provided on the webpages at least once.
...
Similar to gtExtras, to plot an interactive sparklines by using reactablefmtr package, prepare the list field by using the code chunk below.
